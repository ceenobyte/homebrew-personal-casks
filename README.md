...
| Cask | Token | Notes |
| --- | --- | --- |
| [Angry IP Scanner](Casks/angry-ip-scanner.rb) | `angry-ip-scanner` | Disabled upstream: `fails_gatekeeper_check` |
...
| [MarkText](Casks/mark-text.rb) | `mark-text` | Disabled upstream: `fails_gatekeeper_check` |
